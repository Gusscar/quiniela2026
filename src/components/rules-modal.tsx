...
const extraRules = [
  { label: 'Tiempo Oficial', value: "Solo cuentan los 90 min + tiempo añadido. El tiempo extra y penales NO se incluyen en el marcador." },
  { label: 'Cierre', value: 'Cada partido se bloquea 5 minutos antes de su inicio.' },
