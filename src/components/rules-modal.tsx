...
const scoring = [
  {
    ...
    desc: 'Aciertas el marcador exacto al finalizar los 120 minutos.',
    example: 'Predices 2-1 → termina 2-1',
  },
  {
    pts: 2,
    color: 'bg-blue-600 text-white',
    title: 'Resultado sin marcador',
    desc: 'Aciertas quién gana o que termina en empate, pero con marcador diferente.',
    example: 'Predices 2-1 → termina 3-1 · Predices 1-1 → termina 0-0',
  },
  {
    pts: '+1',
    color: 'bg-yellow-500 text-black',
    title: 'Equipo que avanza (empate)',
    desc: 'Si el partido termina empatado en 120 min y aciertas el equipo que avanza por penales.',
    example: 'Los penales solo definen quién pasa, no afectan el marcador.',
  },
  {
    pts: 0,
...
const extraRules = [
  { label: 'Fecha Límite', value: '30 min antes del primer partido de Dieciseisavos.' },
  { label: 'Tiempo Oficial', value: "Marcador válido hasta los 120' (90' + prórroga). Los penales solo definen clasificado." },
  { label: 'Premiación', value: 'Un único ganador se lleva el 90% del pozo.' },
  { label: 'Empate en Puntos', value: 'El premio se divide en partes iguales.' },
